...
<body>
	<div class="container">
		...
		<div class="ui segment attached">
			...
			<f:form class="ui form" modelAttribute="client" action="store" method="POST">
			  ...
			  <div class="two fields">
			  	<div class="field">
		    		...
		    		<f:select path="typeIdentity" items="${identityTypes}" />
			    </div>
			    <div class="field">
			  ...
			  <button class="ui button" type="submit">Créer client</button>
			</f:form>			
